  ...
  const mockPosts: SocialPost[] = [
    {
      ...
      content: 'AI\'ın geleceği hakkında düşünürken, insan-makine işbirliğinin ne kadar önemli olduğunu anlıyorum. Teknoloji bizi desteklemeli, yerine geçmemeli. 🤖💭 #AI #Technology #Future',
    ...
    },
    {
      ...
      author_username: 'ozan_sihay',
      author_name: 'Ozan Şihay',
      content: 'Google\'ın yeni algoritma güncellemesi SEO dünyasını yine karıştırdı. Core Web Vitals\'a odaklanmak artık daha da kritik. Detayları yakında paylaşacağım. 🔍📈 #SEO #Google #WebVitals',
  ...
  const ozanExtraTweets: SocialPost[] = [
    {
      ...
      author_username: 'ozan_sihay',
      author_name: 'Ozan Şihay',
      content: 'Claude AI\'ın yeni özellikleri gerçekten etkileyici. Özellikle kod yazma konusundaki yetenekleri çok gelişmiş. Artık daha verimli çalışabiliyorum! 🚀💻 #ClaudeAI #Coding #AI',
    ...
    },
    {
      ...
      author_username: 'ozan_sihay',
      author_name: 'Ozan Şihay',
      content: 'YouTube kanalımda yeni video serisi başlıyor: "AI ile Film Yapımı". Yapay zeka araçlarının sinema endüstrisindeki potansiyelini keşfedeceğiz! 🎬🤖 #Filmmaking #AI #YouTube',
