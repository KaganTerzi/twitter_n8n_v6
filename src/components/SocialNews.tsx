...
export const SocialNews: React.FC = () => {
  ...
  const tweets = socialPosts.length > 0 ? socialPosts.map(post => ({
    ...
    },
    {
      ...
      sentiment: 0.88,
      viralScore: 71,
      hashtags: ['#Filmmaking', '#AI', '#YouTube'],
      mentions: [],
      engagement: 6.8,
      authorId: '1',
      author_username: 'ozan_sihay',
    ...
    },
    {
      id: '4',
      platform: 'twitter',
      post_id: 'ozan_tweet_4',
      content: 'Kanada\'da çektiğim belgesel projesinden bir kare paylaşıyorum. Doğanın büyüleyici güzelliği karşısında insanın ne kadar küçük olduğunu hissediyorsun. 🌲📸 #Documentary #Nature #Canada',
